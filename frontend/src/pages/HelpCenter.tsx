...
const translations = {
  ...
  fr: {
    ...
    subtitle: "Recherchez dans le centre d'aide ou parcourez les categories ci-dessous",
    searchPlaceholder: "Rechercher de l'aide...",
    browseCategories: "Parcourir les categories",
    popularArticles: "Articles populaires",
    needMoreHelp: "Besoin d'aide supplementaire ?",
    categories: [
      { title: "Demarrage", description: "Apprenez les bases d'utilisation de UBUTABERA", descriptionHub: "hub" },
      { title: "Gestion des dossiers", description: "Comment suivre et gerer vos dossiers juridiques" },
      { title: "Ressources juridiques", description: "Acces aux modeles et lois" },
      { title: "Compte et securite", description: "Gerer votre profil et votre confidentialite" },
      { title: "Assistant IA", description: "Profitez au maximum de l'aide juridique IA" },
      { title: "Facturation et forfaits", description: "Informations sur les tarifs et abonnements" },
    ],
    articles: [
      "Comment ouvrir un nouveau dossier",
      "Trouver l'avocat adapte a vos besoins",
      "Reinitialiser votre mot de passe",
      "Comprendre les frais de justice au Rwanda",
    ],
    contactOptions: {
      chat: { title: "Assistant IA", description: "Obtenez des reponses instantanees", button: "Demarrer" },
      email: { title: "Support e-mail", description: "Reponse sous 24 heures", button: "Envoyer" },
      phone: { title: "Appelez-nous", description: "Lun-Ven, 8h - 17h", button: "Appeler" }
    }
  },
};
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="flex justify-end">
             <div className="flex items-center gap-2">
               <Button variant={lang === "en" ? "default" : "ghost"} size="sm" onClick={() => setLang("en")}>English</Button>
               <Button variant={lang === "rw" ? "default" : "ghost"} size="sm" onClick={() => setLang("rw")}>Kinyarwanda</Button>
               <Button variant={lang === "fr" ? "default" : "ghost"} size="sm" onClick={() => setLang("fr")}>Francais</Button>
             </div>
          </div>
